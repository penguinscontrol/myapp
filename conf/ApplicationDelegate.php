...
class conf_ApplicationDelegate {
	...
	'show_result_stats'=>0, // Show the result statistics (e.g. found x of y records in table z)
	'show_jump_menu'=>0, //Show he drop-down menu that allows you to "jump" to any record in the found set.
	'show_actions_menu'=>0, //Show New record, Show all, delete, etc..
	...
	'disable_select_rows'=>1, //A value of 1 causes the checkboxes in each row of the list view to be hidden.
	);
	}
}
?>